...
\begin{titlepage}
    ...
    \makebox[\textwidth][l]{%
        \parbox{\dimexpr\textwidth-2.5cm\relax}{
            \setstretch{1.03}
            \raggedright\bfseries\CJKfontspec{Songti SC}\fontsize{24}{26}\selectfont\thetitle
        }
    }
    ...
    % Author
    {\noindent\bfseries\CJKfontspec{Songti SC}\fontsize{14}{19}\selectfont\firstauthorname}
    ...
    \hspace*{-2.5pt}\begin{tabular}{@{}r@{\hspace{5pt}}>{\raggedright\arraybackslash}m{6cm}@{}}
        \CJKfontspec{Songti SC}\textbf{指导老师:} & \supname \\ [-.7ex]
        \ifdefined\suptitle
            & \setstretch{0.9}{\fontsize{8}{10}\selectfont\itshape \suptitle} \\ [2ex]
        \fi
        
        \ifdefined\cosupname
            \CJKfontspec{Songti SC}\textbf{助教:} & \cosupname \\ [-.7ex]
            \ifdefined\cosuptitle
    ...
    % School
	{\noindent\CJKfontspec{Songti SC}\fontsize{10}{12}\selectfont\schoolname}
